...
//_\TLV
   ...
   //_\source /raw.githubusercontent.com/osfpga/VirtualFPGALab/35e36bd144fddd75495d4cbc01c4fc50ac5bde6f/tlvlib/tinytapeoutlib.tlv 76   // Instantiated from top.tlv, 231 as: m5+tt_connections()
   ...
   //_\source /raw.githubusercontent.com/osfpga/VirtualFPGALab/a069f1e4e19adc829b53237b3e0b5d6763dc3194/tlvlib/fpgaincludes.tlv 307   // Instantiated from top.tlv, 234 as: m5+board(/top, /fpga, 7, $, , my_design)
            ...
            //_\source top.tlv 49   // Instantiated from /raw.githubusercontent.com/osfpga/VirtualFPGALab/a069f1e4e19adc829b53237b3e0b5d6763dc3194/tlvlib/fpgaincludes.tlv, 340 as: m4+my_design.
               //_|time
                  //_@0
                     ...
                     $clk_disp = >>2$clk_disp ? 1'b0 : >>2$clk_disp + 1'b1;
                     ...
                     *uo_out[7:0] = {$clk_disp,
                        ...
                        //(($digit == 4'd1) && ($btn == 4'd0 || $btn == 4'd4)) ? 7'b0000110 :
                        ($digit == 4'd1) ? 7'b0000110 :
                        ($digit == 4'd2) ? 7'b1011011 :
                        //(($digit == 4'd3) && ($btn == 4'd1 || $btn == 4'd2)) ? 7'b1001111 :
                     ...
                     */
                     ...
                     assign FpgaPins_Fpga_TIME_ones_a0[3:0] =
                        ...
                        FpgaPins_Fpga_TIME_btn_a0 == 4'd0 ? 4'd10 :
                        FpgaPins_Fpga_TIME_btn_a0 == 4'd1 ? 4'd9 :
                        //>>1$time_clk && (>>1$ones == 4'd0) && (>>1$tens == 4'd0) && $start ? 4'd0 :
                        ...
                        FpgaPins_Fpga_TIME_time_clk_a1 && (FpgaPins_Fpga_TIME_ones_a1 == 4'd0) && (FpgaPins_Fpga_TIME_tens_a1 == 4'd0) && FpgaPins_Fpga_TIME_start_a0 ? 4'd0 :
                     ...
                     assign FpgaPins_Fpga_TIME_tens_a0[3:0] =
                        FpgaPins_Fpga_TIME_reset_a0 ? 4'd9 :
                        FpgaPins_Fpga_TIME_btn_a0 == 4'd0 ? 4'd1 :
                        FpgaPins_Fpga_TIME_btn_a0 == 4'd1 ? 4'd9 :
                        //(>>1$sec_cnt == 4'd10) && (>>1$tens == 4'd0) && (>>1$ones == 4'd0) && $start ? 4'd0 :
                        ...
                        (FpgaPins_Fpga_TIME_sec_cnt_a1 == 4'd10) && (FpgaPins_Fpga_TIME_tens_a1 == 4'd0) && (FpgaPins_Fpga_TIME_ones_a1 == 4'd0) && FpgaPins_Fpga_TIME_start_a0 ? 4'd0 :
                     ...
                     assign uo_out[7:0] = {FpgaPins_Fpga_TIME_clk_disp_a0,
                        (FpgaPins_Fpga_TIME_digit_a0 == 4'd0) ? 8'b10111111 :
                        (FpgaPins_Fpga_TIME_digit_a0 == 4'd1) ? 8'b10000110 :
                        (FpgaPins_Fpga_TIME_digit_a0 == 4'd2) ? 8'b11011011 :
                        (FpgaPins_Fpga_TIME_digit_a0 == 4'd3) ? 8'b11001111 :
                        (FpgaPins_Fpga_TIME_digit_a0 == 4'd4) ? 8'b11100110 :
                        (FpgaPins_Fpga_TIME_digit_a0 == 4'd5) ? 8'b11101101 :
                        (FpgaPins_Fpga_TIME_digit_a0 == 4'd6) ? 8'b11111101 :
                        (FpgaPins_Fpga_TIME_digit_a0 == 4'd7) ? 8'b10000111 :
                        (FpgaPins_Fpga_TIME_digit_a0 == 4'd8) ? 8'b11111111 :
                        (FpgaPins_Fpga_TIME_digit_a0 == 4'd9) ? 8'b11101111 :
                        (FpgaPins_Fpga_TIME_digit_a0 == 4'd10) ? 8'b01110011 :
                                         8'b10000000};
   ...
   //_\source /raw.githubusercontent.com/osfpga/VirtualFPGALab/35e36bd144fddd75495d4cbc01c4fc50ac5bde6f/tlvlib/tinytapeoutlib.tlv 82   // Instantiated from top.tlv, 236 as: m5+tt_input_labels_viz(⌈"UNUSED", "UNUSED", "UNUSED", "UNUSED", "UNUSED", "UNUSED", "UNUSED", "UNUSED"⌉)
